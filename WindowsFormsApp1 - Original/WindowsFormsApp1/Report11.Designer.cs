...
namespace WindowsFormsApp1 {
    ...
    public partial class Report : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Employee_Id, System.DateTime Joining_Date, string FirstName, string LastName, string Branch, string Telephone, string Email, System.DateTime Date_of_Birth, string Designation, int Salary) {
...
namespace WindowsFormsApp1.ReportTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Employee_Id], [Joining_Date], [FirstName], [LastName], [Branch], [Telephone], [Email], [Date_of_Birth], [Designation], [Salary]) VALUES (@Employee_Id, @Joining_Date, @FirstName, @LastName, @Branch, @Telephone, @Email, @Date_of_Birth, @Designation, @Salary);
SELECT Employee_Id, Joining_Date, FirstName, LastName, Branch, Telephone, Email, Date_of_Birth, Designation, Salary FROM Employee WHERE (Employee_Id = @Employee_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Employee_Id] = @Employee_Id, [Joining_Date] = @Joining_Date, [FirstName] = @FirstName, [LastName] = @LastName, [Branch] = @Branch, [Telephone] = @Telephone, [Email] = @Email, [Date_of_Birth] = @Date_of_Birth, [Designation] = @Designation, [Salary] = @Salary WHERE (([Employee_Id] = @Original_Employee_Id) AND ((@IsNull_Joining_Date = 1 AND [Joining_Date] IS NULL) OR ([Joining_Date] = @Original_Joining_Date)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Date_of_Birth = 1 AND [Date_of_Birth] IS NULL) OR ([Date_of_Birth] = @Original_Date_of_Birth)) AND ((@IsNull_Designation = 1 AND [Designation] IS NULL) OR ([Designation] = @Original_Designation)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));
SELECT Employee_Id, Joining_Date, FirstName, LastName, Branch, Telephone, Email, Date_of_Birth, Designation, Salary FROM Employee WHERE (Employee_Id = @Employee_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Employee_Id, Joining_Date, FirstName, LastName, Branch, Telephone, Email, " +
                "Date_of_Birth, Designation, Salary FROM dbo.Employee";
        ...
        public virtual int Fill(Report.EmployeeDataTable dataTable) {
        ...
        public virtual Report.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Report.EmployeeDataTable dataTable = new Report.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Report.EmployeeDataTable dataTable) {
        ...
        public virtual int Insert(string Employee_Id, global::System.Nullable<global::System.DateTime> Joining_Date, string FirstName, string LastName, string Branch, string Telephone, string Email, global::System.Nullable<global::System.DateTime> Date_of_Birth, string Designation, global::System.Nullable<int> Salary) {
            if ((Employee_Id == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_Branch == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_Branch));
            }
            if ((Original_Telephone == null)) {
            ...
            if ((Original_Salary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[28].Value = ((int)(Original_Salary.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_Designation, 
                    global::System.Nullable<int> Original_Salary) {
            return this.Update(Original_Employee_Id, Joining_Date, FirstName, LastName, Branch, Telephone, Email, Date_of_Birth, Designation, Salary, Original_Employee_Id, Original_Joining_Date, Original_FirstName, Original_LastName, Original_Branch, Original_Telephone, Original_Email, Original_Date_of_Birth, Original_Designation, Original_Salary);
        }
    }
